...
class PlanarCar:
    ...
    def draw_rotated_tire(self, ax, center, width, height, angle_degrees, color='b'):
    ...
    def draw_rotated_rectangle(self, ax, center, width, height, angle_degrees, color='b'):
...
def main(argv):
    ...
    fig.canvas.mpl_connect('key_press_event', car.on_key)
